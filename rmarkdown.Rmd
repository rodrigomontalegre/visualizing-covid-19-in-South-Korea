...
lm2 <- lm(mean_fp_num ~ count + avg_temp,
          data = SeoulFloating)
...
print(lm2)
```
As shown in the first table, the daily count of cases in Seoul has negative effect on the average floating population and the effect is statistically significant. Once we perform a multiple regression analysis including average daily temperature, the effect of the daily count diminishes. Both are statistically significant.
