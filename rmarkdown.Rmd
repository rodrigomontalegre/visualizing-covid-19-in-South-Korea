...
print(fp_plot)
```
As we can see, there seems to be a natural increase and decrease of the floating population over time. However, there seems to be a possible outlier occuring in the second half of February. There are also strong decreases in the second half of January, in the first half of March and the beginning of May.
